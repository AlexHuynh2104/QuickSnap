...
<<<<<<< HEAD
            SwinGame.LoadFontNamed("GameFont", "Arial.otf", 12);
=======
            SwinGame.LoadFontNamed("GameFont", "Chunkfive.otf", 12);
	    SwinGame.LoadFontNamed("GameFont1", "Arial.otf", 12);
>>>>>>> 2ee22d43dcb9fafc3db541deb6380cb9bae388b6
        }
		...
		private static void DrawGame(Snap myGame)
		{
			...
			if (top != null)
			{
				...
				SwinGame.DrawText ("Player 2 score: " + myGame.Score(1), Color.RoyalBlue, "GameFont1", 0, 40);
